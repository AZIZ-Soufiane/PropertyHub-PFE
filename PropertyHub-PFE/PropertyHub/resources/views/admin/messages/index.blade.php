            ...
            @forelse($conversations as $conv)
                ...
                <a href="{{ route('admin.messages.show', $other) }}"
                    ...
                    <div class="grow min-w-0">
                        ...
                        <p class="text-xs text-slate-500 truncate font-medium">{{ $conv->content }}</p>
                    </div>
                    <span class="text-[10px] text-slate-400 font-bold whitespace-nowrap">{{ $conv->created_at->diffForHumans(null, true) }}</span>
                </a>
            @empty
