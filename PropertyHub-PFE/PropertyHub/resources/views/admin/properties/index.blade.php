...
@section('header-actions')
    <button type="button" @click="showCreateModal = true"
            class="hidden sm:inline-flex items-center gap-x-2 py-2.5 px-4 text-sm font-bold rounded-xl bg-primary-600 text-white hover:bg-primary-700 shadow-md shadow-primary-500/20 transition-all">
...
@section('content')
<div x-data="{ showCreateModal: {{ !old('_method') && $errors->any() ? 'true' : 'false' }} }">
            ...
            <table class="min-w-full divide-y divide-slate-100">
                ...
                <tbody class="divide-y divide-slate-50">
                    @forelse($properties as $property)
                        <tr x-data="{ showEditModal: {{ old('property_id') == $property->id && $errors->any() ? 'true' : 'false' }} }" class="hover:bg-slate-50 transition-colors">
