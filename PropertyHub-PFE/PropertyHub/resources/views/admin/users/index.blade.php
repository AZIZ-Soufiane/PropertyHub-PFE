                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <div class="inline-flex items-center gap-1">
                                <button type="button" @click="viewUser = JSON.parse($el.getAttribute('data-user')); showViewModal = true" data-user='{{ json_encode([
                                    'id' => $u->id,
                                    'name'  => $u->name,
                                    'email' => $u->email,
                                    'role'  => $u->role,
                                ...
                                <button type="button" @click="editUser = JSON.parse($el.getAttribute('data-edit-user')); showEditModal = true" data-edit-user='{{ json_encode([
                                    'id' => $u->id,
                                    'name'  => $u->name,
                                    'email' => $u->email,
                                    'role'  => $u->role,
                ...
                <div class="p-8 overflow-y-auto max-h-[70vh] bg-white space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required class="py-3 px-4 block w-full border border-slate-200 rounded-xl text-sm focus:border-primary-500 focus:ring-primary-500 outline-none">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="license_number" value="{{ old('license_number') }}" class="py-3 px-4 block w-full border border-slate-200 rounded-xl text-sm focus:border-primary-500 focus:ring-primary-500 outline-none">
                        </div>
                    </div>
                </div>
                <div class="bg-slate-50/50 flex justify-end gap-3 py-4 px-6 border-t border-slate-100">
