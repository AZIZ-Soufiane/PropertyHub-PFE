        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
            <div class="h-96 lg:h-[500px] rounded-3xl overflow-hidden">
                <img id="mainImage" class="w-full h-full object-cover" 
                    src="{{ $property->images->first()?->url ?? 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200' }}" 
                    alt="{{ $property->title }}">
            </div>
        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="w-full lg:w-1/3">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sticky top-24">
                    ...
                    <div class="space-y-3">
                        <a href="mailto:{{ $property->agent?->email ?? 'contact@propertyhub.com' }}?subject=Inquiry about {{ $property->title }}" 
