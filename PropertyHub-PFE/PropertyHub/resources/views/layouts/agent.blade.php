                    ...
                    <div class="flex items-center gap-x-4 ms-auto">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak
                                ...
                                <a href="{{ route('home') }}" class="flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                ...
                                <a href="{{ route('agent.dashboard') }}" class="flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
