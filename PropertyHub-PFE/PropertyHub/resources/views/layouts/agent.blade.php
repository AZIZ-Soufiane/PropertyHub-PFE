...
<head>
    ...
    <title>{{ $title ?? 'Agent Portal — PropertyHub' }}</title>
        ...
        <aside id="application-sidebar"
            ...
            <nav class="px-4 sm:px-6 flex-1">
                <ul class="space-y-1.5">
                    <li>
                        <a class="flex items-center gap-x-3 sm:gap-x-3.5 py-2 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all {{ request()->routeIs('agent.dashboard') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100' }}"
                           href="{{ route('agent.dashboard') }}" @click="sidebarOpen = false">
                    ...
                    <li>
                        <a class="w-full flex items-center gap-x-3 sm:gap-x-3.5 py-2 sm:py-2.5 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all {{ request()->routeIs('agent.properties.*') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100' }}"
                           href="{{ route('agent.properties.index') }}" @click="sidebarOpen = false">
                    ...
                    <li>
                        <a class="w-full flex items-center gap-x-3 sm:gap-x-3.5 py-2 sm:py-2.5 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all {{ request()->routeIs('agent.appointments.*') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100' }}"
                           href="{{ route('agent.appointments.index') }}" @click="sidebarOpen = false">
                    ...
                    <li>
                        <a class="w-full flex items-center gap-x-3 sm:gap-x-3.5 py-2 sm:py-2.5 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all {{ request()->routeIs('agent.messages.*') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100' }}"
                           href="{{ route('agent.messages.index') }}" @click="sidebarOpen = false">
                    ...
                    <div class="flex items-center gap-x-4 ms-auto">
                        ...
                        <div class="hs-dropdown relative inline-flex">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] hs-dropdown-open:opacity-100 opacity-0 hidden w-56 bg-white shadow-xl rounded-2xl border border-gray-100 mt-2 z-50 overflow-hidden"
                                ...
                                <div class="p-1">
                                    <a href="{{ route('home') }}" class="flex items-center gap-x-3 py-2 px-3 rounded-xl text-sm text-gray-700 hover:bg-gray-100 font-medium transition-colors">
                                    ...
                                    <a href="{{ route('agent.dashboard') }}" class="flex items-center gap-x-3 py-2 px-3 rounded-xl text-sm text-gray-700 hover:bg-gray-100 font-medium transition-colors">
