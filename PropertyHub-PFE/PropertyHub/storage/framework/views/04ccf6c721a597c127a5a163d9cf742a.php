            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="<?php echo e(route('admin.appointments.index')); ?>"
                       class="flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-xl transition-all <?php echo e(request()->routeIs('admin.appointments.*') ? 'bg-primary-50 text-primary-500 font-bold' : 'text-slate-600 font-medium hover:bg-slate-100'); ?>">
