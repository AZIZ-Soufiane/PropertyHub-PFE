    ...
    <div class="min-h-screen flex">
        <aside class="fixed top-0 start-0 bottom-0 w-64 bg-white border-e border-gray-200 flex flex-col pt-6 pb-10 z-50 hidden lg:flex">
            ...
            <nav class="px-6 flex-1">
                <ul class="space-y-1">
                    <li>
                        <a class="flex items-center gap-3.5 py-2.5 px-3 text-sm font-bold rounded-xl <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-100'); ?>"
                    ...
                    <li>
                        <a class="flex items-center gap-3.5 py-2.5 px-3 text-sm font-medium rounded-xl text-gray-700 hover:bg-gray-100 <?php echo e(request()->routeIs('admin.users.*') ? 'bg-gray-100' : ''); ?>"
                    ...
                    <li>
                        <a class="flex items-center gap-3.5 py-2.5 px-3 text-sm font-medium rounded-xl text-gray-700 hover:bg-gray-100 <?php echo e(request()->routeIs('admin.properties.*') ? 'bg-gray-100' : ''); ?>"
...
</html><?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views/layouts/admin.blade.php ENDPATH**/ ?>