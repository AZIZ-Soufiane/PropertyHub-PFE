...
<header class="fixed top-0 inset-x-0 z-50 w-full bg-white/80 border-b border-gray-100 py-4 backdrop-blur-xl">
    <nav class="max-w-7xl mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
        ...
        <div class="hidden sm:flex items-center gap-x-8">
            ...
            <a class="font-semibold text-gray-500 hover:text-blue-600 transition-colors" href="<?php echo e(route('properties.index')); ?>">Properties</a>
            <a class="font-semibold text-gray-500 hover:text-blue-600 transition-colors" href="<?php echo e(route('compare')); ?>">Compare</a>
            <?php if(auth()->guard()->check()): ?>
                <a class="font-semibold text-gray-500 hover:text-blue-600 transition-colors" href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
            <?php else: ?>
                <a class="py-2.5 px-6 bg-gray-900 text-white rounded-xl text-sm font-bold hover:bg-black transition-all" href="<?php echo e(route('login')); ?>">Sign In</a>
            <?php endif; ?>
        </div>
    </nav>
</header>
...
<main>
    ...
    <section class="relative min-h-screen flex items-center justify-center hero-pattern">
        <div class="relative max-w-5xl mx-auto px-4 text-center z-10">
            ...
            <!-- Search Bar -->
            <form action="<?php echo e(route('properties.search')); ?>" method="GET" class="glass-dark p-2 rounded-2xl max-w-4xl mx-auto">
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex justify-between items-end mb-16">
                ...
                <a href="<?php echo e(route('properties.index')); ?>" class="inline-flex items-center gap-2 text-sm font-black text-gray-900 px-6 py-3 border border-gray-100 rounded-xl hover:bg-gray-50 transition-all">
                    View All
                    ...
                    <div class="group flex flex-col bg-white border border-gray-50 shadow-sm rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-700">
                        <div class="h-72 overflow-hidden relative">
                            <img class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
                                src="<?php echo e($property->images->first()?->url ?? 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800'); ?>"
                        ...
                        <div class="p-8">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-2xl font-black text-blue-600">$<?php echo e(number_format($property->price)); ?></span>
                                <div class="flex gap-6">
                                    <div class="text-sm font-bold">
                                        <span class="block text-gray-400 text-[10px] uppercase font-black tracking-widest">Beds</span><?php echo e($property->bedrooms); ?>

                                    </div>
                                    <div class="text-sm font-bold">
                                        <span class="block text-gray-400 text-[10px] uppercase font-black tracking-widest">Baths</span><?php echo e($property->bathrooms); ?>

                                    </div>
                                </div>
                            </div>
                            <a href="<?php echo e(route('properties.show', $property)); ?>" class="mt-6 w-full py-4 block text-center text-sm bg-gray-50 text-gray-900 font-black rounded-2xl group-hover:bg-blue-600 group-hover:text-white transition-all">
                                Explore Property
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views/frontend/home.blade.php ENDPATH**/ ?>