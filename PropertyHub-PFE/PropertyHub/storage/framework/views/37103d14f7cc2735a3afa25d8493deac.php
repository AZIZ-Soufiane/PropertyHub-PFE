                ...
                <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <p class="text-xs text-gray-400"><?php echo e(optional($appt->property)->city); ?>, <?php echo e(optional($appt->property)->country); ?></p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php if($appt->agent): ?>
                                <div class="flex items-center gap-2">
                                    <span class="size-7 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center font-bold text-xs"><?php echo e(strtoupper(substr($appt->agent->name, 0, 1))); ?></span>
                                    <span class="text-sm text-gray-700 font-medium"><?php echo e($appt->agent->name); ?></span>
                                </div>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <p class="text-sm font-medium text-gray-800"><?php echo e($appt->date_time->format('M d, Y')); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($appt->date_time->format('H:i')); ?></p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="py-1 px-3 inline-flex items-center gap-1 rounded-full text-[10px] font-bold <?php echo e($pill); ?> uppercase">
                                <span class="size-1.5 rounded-full bg-current"></span><?php echo e(ucfirst($appt->status)); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <?php if($appt->agent): ?>
                                <a href="<?php echo e(route('buyer.messages.show', $appt->agent)); ?>"
...
<?php echo $__env->make('layouts.buyer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views/buyer/appointments/index.blade.php ENDPATH**/ ?>