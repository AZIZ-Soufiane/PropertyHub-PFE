                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] hs-dropdown-open:opacity-100 opacity-0 hidden w-80 bg-white shadow-xl rounded-2xl border border-gray-100 mt-2 z-50 overflow-hidden"
                                ...
                                <div class="divide-y divide-gray-50 max-h-72 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="flex items-start gap-3 px-4 py-3 <?php echo e($notification->read_at ? 'opacity-60' : 'hover:bg-gray-50 transition-colors'); ?>">
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-semibold text-gray-800"><?php echo e($notification->data['title'] ?? 'Notification'); ?></p>
                                                <p class="text-xs text-gray-400 mt-0.5"><?php echo e($notification->data['message'] ?? ''); ?></p>
                                                <p class="text-[10px] text-gray-300 font-semibold mt-1"><?php echo e($notification->created_at->diffForHumans()); ?></p>
                                            </div>
