<?php $__env->startSection('title', 'Create Account — PropertyHub'); ?>
            ...
            <div class="p-4 sm:p-6 md:p-8">
                <div class="text-center">
                    ...
                    <p class="mt-2 sm:mt-3 text-xs sm:text-sm text-gray-600">
                        ...
                        <a class="text-primary-500 decoration-2 hover:underline font-medium" href="<?php echo e(route('login')); ?>">Sign in</a>
                    </p>
                </div>
                    ...
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="grid gap-y-4 sm:gap-y-5 md:gap-y-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required class="py-2 sm:py-3 px-3 sm:px-4 block w-full border border-gray-200 rounded-lg text-xs sm:text-sm focus:border-primary-500 focus:ring-primary-500 outline-none" placeholder="John Doe">
                            </div>

                            <div>
                                <label for="email" class="block text-xs sm:text-sm mb-2 sm:mb-3 text-gray-900">Email address</label>
                                <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required class="py-2 sm:py-3 px-3 sm:px-4 block w-full border border-gray-200 rounded-lg text-xs sm:text-sm focus:border-primary-500 focus:ring-primary-500 outline-none" placeholder="your@email.com">
                            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views\auth\register.blade.php ENDPATH**/ ?>