...
<div class="flex flex-col lg:flex-row h-[calc(100vh-200px)] gap-0 bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
    <div class="w-full lg:w-1/3 border-r border-gray-100 flex flex-col bg-gray-50/30">
        ...
        <div class="overflow-y-auto flex-1">
            <a href="<?php echo e(route('agent.messages.show', $user)); ?>"
    ...
    <div class="w-full lg:w-2/3 flex flex-col relative h-full">
        ...
        <div class="p-6 bg-white border-t border-gray-100">
            <form action="<?php echo e(route('agent.messages.store')); ?>" method="POST" class="flex items-center gap-3">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views\agent\messages\show.blade.php ENDPATH**/ ?>