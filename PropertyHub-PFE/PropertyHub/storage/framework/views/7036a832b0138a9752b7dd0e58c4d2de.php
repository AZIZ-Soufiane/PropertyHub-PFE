...
<div class="mb-8 flex justify-between items-center">
    ...
    <a href="<?php echo e(route('admin.users.create')); ?>" class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-bold rounded-xl bg-blue-600 text-white hover:bg-blue-700">
...
<div class="bg-white border border-gray-200 rounded-3xl overflow-hidden">
    <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="px-6 py-4 border-b border-gray-100 flex flex-col md:flex-row gap-3">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <p class="text-sm font-bold text-gray-800"><?php echo e($u->name); ?></p>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo e($u->email); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="py-1 px-3 rounded-full text-[10px] font-bold
                                <?php echo e($u->role === 'admin' ? 'bg-purple-100 text-purple-700' : ($u->role === 'agent' ? 'bg-blue-100 text-blue-700' : 'bg-emerald-100 text-emerald-700')); ?>">
                                <?php echo e(ucfirst($u->role)); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($u->created_at->format('M d, Y')); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <a href="<?php echo e(route('admin.users.show', $u)); ?>" class="text-xs text-blue-600 hover:underline mr-3">View</a>
                            <a href="<?php echo e(route('admin.users.edit', $u)); ?>" class="text-xs text-amber-600 hover:underline mr-3">Edit</a>
                            <?php if($u->id !== auth()->id()): ?>
