...
<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
    <div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-2xl p-5">
        ...
        <div class="flex items-center gap-x-3">
            <h3 class="text-3xl font-black text-gray-800"><?php echo e($stats['active_listings']); ?></h3>
            <?php if($stats['new_this_week'] ?? 0): ?>
    ...
    <div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-2xl p-5">
        ...
        <div class="flex items-center gap-x-3">
            <h3 class="text-3xl font-black text-gray-800"><?php echo e($stats['pending_viewings']); ?></h3>
    ...
    <div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-2xl p-5">
        ...
        <div class="flex items-center gap-x-3">
            <h3 class="text-3xl font-black text-gray-800"><?php echo e($stats['total_appointments']); ?></h3>
        </div>
    </div>
    <div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-2xl p-5">
        <p class="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Unread Messages</p>
        <div class="flex items-center gap-x-3">
            <h3 class="text-3xl font-black text-gray-800"><?php echo e($stats['unread_messages']); ?></h3>
        </div>
    </div>
</div>
...
<div class="grid lg:grid-cols-2 gap-8">
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('agent.appointments.index')); ?>" class="text-sm font-semibold text-primary-600 hover:text-primary-700">View Calendar</a>
        </div>
        <?php $__empty_1 = true; $__currentLoopData = $upcomingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-2xl p-5 group hover:border-primary-300 transition-all">
                <div class="flex justify-between items-start mb-4">
                    <div class="space-y-1">
                        <h3 class="font-bold text-gray-800 text-lg"><?php echo e($appt->date_time->format('D, M d')); ?></h3>
                        <p class="text-sm text-gray-500 font-medium"><?php echo e($appt->date_time->format('H:i A')); ?> - <?php echo e($appt->date_time->copy()->addHour()->format('H:i A')); ?></p>
                    </div>
                    <?php
                        $statusColors = [
                ...
                <div class="mb-5 p-4 bg-gray-50 rounded-2xl">
                    <p class="text-sm text-gray-800 font-bold mb-1"><?php echo e(optional($appt->property)->title ?? 'Property deleted'); ?></p>
                    <p class="text-xs text-gray-500 flex items-center gap-2">
                        ...
                        <?php echo e(optional($appt->client)->name ?? 'Unknown'); ?>

                    </p>
                </div>
                <?php if($appt->status === 'pending'): ?>
                    <div class="flex gap-x-2">
                        <form action="<?php echo e(route('agent.appointments.confirm', $appt)); ?>" method="POST" class="flex-1">
                            <?php echo csrf_field(); ?>
    ...
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('agent.messages.index')); ?>" class="text-sm font-semibold text-primary-600 hover:text-primary-700">Open Inbox</a>
        </div>
        <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
            <div class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <a href="<?php echo e(route('agent.messages.show', $sender)); ?>"
                        ...
                        <div class="size-11 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center font-bold flex-shrink-0 group-hover:ring-2 ring-primary-500/50 transition-all">
                            <?php echo e(strtoupper(substr($sender->name ?? '?', 0, 1))); ?>

                        </div>
                        <div class="grow min-w-0">
                            <div class="flex justify-between items-center mb-0.5">
                                <h4 class="text-sm font-bold text-gray-800 truncate"><?php echo e($sender->name ?? 'Unknown'); ?></h4>
                            ...
                            <p class="text-xs text-gray-500 truncate"><?php echo e($msg->content); ?></p>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-3xl overflow-hidden">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-sm text-gray-500">
                            No properties yet. <a href="<?php echo e(route('agent.properties.index')); ?>" class="text-primary-600 font-semibold">Manage your properties</a>.
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
    ...
    <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
        <p class="text-xs text-gray-400 font-semibold">Showing <?php echo e($recentProperties->count()); ?> properties</p>
        <a href="<?php echo e(route('agent.properties.index')); ?>" class="text-xs font-bold text-primary-600 hover:text-primary-700">View all properties</a>
    </div>
</div>
