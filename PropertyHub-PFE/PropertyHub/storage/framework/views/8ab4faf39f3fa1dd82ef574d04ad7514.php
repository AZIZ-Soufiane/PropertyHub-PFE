...
<?php $__env->startSection('header-actions'); ?>
    <a href="<?php echo e(route('admin.users.create')); ?>" class="hidden sm:inline-flex items-center gap-x-2 py-2 px-4 text-sm font-bold rounded-xl bg-primary-500 text-white hover:bg-primary-600 transition-all shadow-md shadow-primary-500/20">
...
<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
    <div class="flex flex-col bg-white border border-slate-200 shadow-sm rounded-2xl p-5 hover:shadow-md transition-all">
        ...
        <h3 class="text-3xl font-black text-slate-800"><?php echo e(number_format($stats['total_users'])); ?></h3>
        <span class="flex items-center gap-x-1 text-emerald-600 font-bold text-sm mt-2">
            ...
            +<?php echo e($stats['new_users_this_month']); ?> this month
        </span>
    </div>
    <div class="flex flex-col bg-white border border-slate-200 shadow-sm rounded-2xl p-5 hover:shadow-md transition-all">
        <div class="flex items-center gap-x-4 mb-3">
        ...
        <h3 class="text-3xl font-black text-slate-800"><?php echo e(number_format($stats['total_properties'])); ?></h3>
        <span class="flex items-center gap-x-1 text-emerald-600 font-bold text-sm mt-2">
            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
            +<?php echo e($stats['new_properties_this_month']); ?> growth
        </span>
    </div>
    <div class="flex flex-col bg-white border border-slate-200 shadow-sm rounded-2xl p-5 hover:shadow-md transition-all">
        <div class="flex items-center gap-x-4 mb-3">
        ...
        <h3 class="text-3xl font-black text-slate-800"><?php echo e(number_format($stats['total_appointments'])); ?></h3>
        <span class="flex items-center gap-x-1 font-bold text-sm mt-2" style="color:#029fca;">
            <?php echo e($stats['pending_appointments']); ?> pending
        </span>
    </div>
    <div class="flex flex-col bg-white border border-slate-200 shadow-sm rounded-2xl p-5 hover:shadow-md transition-all">
        <div class="flex items-center gap-x-4 mb-3">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white border border-slate-200 rounded-3xl shadow-soft overflow-hidden">
        <div class="flex items-center justify-between px-6 py-5 border-b border-slate-100">
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center gap-1.5 text-xs font-bold text-primary-600 hover:text-primary-700 bg-primary-50 px-3 py-1.5 rounded-full">
                View all
        ...
        <div class="divide-y divide-slate-100">
            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('admin.users.show', $u)); ?>" class="flex items-center gap-4 px-6 py-4 hover:bg-slate-50 transition-colors">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-bold text-slate-800 truncate"><?php echo e($u->name); ?></p>
                        <p class="text-xs text-slate-400 truncate"><?php echo e($u->email); ?></p>
                    </div>
                    <?php
                        $rmap = [
                    ...
                    <span class="text-[10px] font-bold text-slate-400 w-20 text-right hidden sm:block"><?php echo e($u->created_at->diffForHumans()); ?></span>
                </a>
    ...
    <div class="space-y-6">
        <div class="bg-white border border-slate-200 rounded-3xl shadow-soft overflow-hidden">
            ...
            <div class="p-3 space-y-1">
                <a href="<?php echo e(route('admin.properties.index')); ?>" class="flex items-center gap-3 px-3 py-3 rounded-2xl hover:bg-slate-50 group transition-all">
                ...
                <a href="<?php echo e(route('admin.users.create')); ?>" class="flex items-center gap-3 px-3 py-3 rounded-2xl hover:bg-slate-50 group transition-all">
                ...
                <a href="<?php echo e(route('admin.logs.index')); ?>" class="flex items-center gap-3 px-3 py-3 rounded-2xl hover:bg-slate-50 group transition-all">
            ...
            <div class="space-y-3">
                <div>
                    <div class="flex justify-between text-xs font-bold mb-1.5">
                        ...
                        <span class="text-slate-800"><?php echo e($stats['new_users_this_month']); ?></span>
                    </div>
                    <div class="h-1.5 rounded-full bg-slate-100 overflow-hidden">
                        <div class="h-full bg-primary-500 rounded-full" style="width: <?php echo e(min(100, $stats['new_users_this_month'] * 5)); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between text-xs font-bold mb-1.5">
                        <span class="text-slate-500">New listings</span>
                        <span class="text-slate-800"><?php echo e($stats['new_properties_this_month']); ?></span>
                    </div>
                    <div class="h-1.5 rounded-full bg-slate-100 overflow-hidden">
                        <div class="h-full bg-emerald-500 rounded-full" style="width: <?php echo e(min(100, $stats['new_properties_this_month'] * 5)); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between text-xs font-bold mb-1.5">
                        <span class="text-slate-500">Pending appointments</span>
                        <span class="text-slate-800"><?php echo e($stats['pending_appointments']); ?></span>
                    </div>
                    <div class="h-1.5 rounded-full bg-slate-100 overflow-hidden">
                        <div class="h-full bg-amber-500 rounded-full" style="width: <?php echo e(min(100, $stats['pending_appointments'] * 5)); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>