...
<head>
    ...
    <title><?php echo e($title ?? 'My Dashboard — PropertyHub'); ?></title>
        ...
        <aside id="buyer-sidebar"
            ...
            <nav class="px-4 sm:px-6 flex-1">
                <ul class="space-y-1.5">
                    <li>
                        <a class="flex items-center gap-x-3 sm:gap-x-3.5 py-2 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all <?php echo e(request()->routeIs('buyer.dashboard') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100'); ?>"
                           href="<?php echo e(route('buyer.dashboard')); ?>" @click="sidebarOpen = false">
                    ...
                    <li>
                        <a class="w-full flex items-center gap-x-3 sm:gap-x-3.5 py-2 sm:py-2.5 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all <?php echo e(request()->routeIs('buyer.appointments.*') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100'); ?>"
                           href="<?php echo e(route('buyer.appointments.index')); ?>" @click="sidebarOpen = false">
                    ...
                    <li>
                        <a class="w-full flex items-center gap-x-3 sm:gap-x-3.5 py-2 sm:py-2.5 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all <?php echo e(request()->routeIs('buyer.favorites.*') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100'); ?>"
                           href="<?php echo e(route('buyer.favorites.index')); ?>" @click="sidebarOpen = false">
                    ...
                    <li>
                        <a class="w-full flex items-center gap-x-3 sm:gap-x-3.5 py-2 sm:py-2.5 px-3 text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all <?php echo e(request()->routeIs('buyer.messages.*') ? 'bg-primary-50 text-primary-500 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-100'); ?>"
                           href="<?php echo e(route('buyer.messages.index')); ?>" @click="sidebarOpen = false">
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a class="flex items-center gap-x-3 py-2 px-3 text-sm rounded-xl text-gray-600 font-medium hover:bg-gray-100 transition-all"
                               href="<?php echo e(route('properties.index')); ?>">
            ...
            <header class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] bg-white/80 backdrop-blur-md border-b border-gray-200 py-3">
                <nav class="flex items-center justify-between w-full px-4 sm:px-6">
                    ...
                    <div class="flex items-center gap-x-4 ms-auto">
                        <a href="<?php echo e(route('properties.index')); ?>" class="hidden sm:inline-flex items-center gap-2 py-2 px-3 text-sm font-medium text-gray-600 hover:text-primary-600 transition-colors">
                        ...
                        <div class="hs-dropdown relative inline-flex">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] hs-dropdown-open:opacity-100 opacity-0 hidden w-56 bg-white shadow-xl rounded-2xl border border-gray-100 mt-2 z-50 overflow-hidden"
                                ...
                                <div class="p-1">
                                    <a href="<?php echo e(route('buyer.dashboard')); ?>" class="flex items-center gap-x-3 py-2 px-3 rounded-xl text-sm text-gray-700 hover:bg-gray-100 font-medium transition-colors">
...
<?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views/layouts/buyer.blade.php ENDPATH**/ ?>