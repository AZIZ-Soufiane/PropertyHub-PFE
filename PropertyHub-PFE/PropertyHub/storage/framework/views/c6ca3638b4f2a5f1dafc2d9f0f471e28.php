    ...
    <aside class="hidden lg:flex w-full sm:w-64 lg:w-64 flex-shrink-0 bg-white border-r border-slate-200 flex-col pt-6 sm:pt-7 pb-8 sm:pb-10 min-h-screen">
        ...
        <div class="px-4 sm:px-6 mt-auto pt-4 sm:pt-6 border-t border-slate-100">
            <div class="flex items-center gap-3">
                <span class="size-9 rounded-full bg-primary-500 flex items-center justify-center text-white font-black text-sm"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                <div>
                    <p class="text-sm font-bold text-slate-800"><?php echo e(Auth::user()->name); ?></p>
                    <p class="text-[10px] text-slate-400 font-semibold"><?php echo e(Auth::user()->email); ?></p>
                </div>
            </div>
        </div>
    </aside>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hs-dropdown relative inline-flex">
                    <button id="admin-avatar-dropdown" type="button"
                        ...
                        <span class="size-9 rounded-full ring-2 ring-slate-100 bg-primary-500 flex items-center justify-center text-white font-black text-sm"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                    ...
                    <div class="hs-dropdown-menu transition-[opacity,margin] hs-dropdown-open:opacity-100 opacity-0 hidden w-56 bg-white shadow-xl rounded-2xl border border-slate-100 mt-2 z-50 overflow-hidden"
                        ...
                        <div class="px-4 py-3 border-b border-slate-100">
                            <p class="text-sm font-black text-slate-800"><?php echo e(Auth::user()->name); ?></p>
                            <p class="text-xs text-slate-400 mt-0.5"><?php echo e(Auth::user()->email); ?></p>
                        </div>
                        <div class="p-1">
                            <a href="<?php echo e(route('admin.users.show', Auth::id())); ?>" class="flex items-center gap-x-3 py-2 px-3 rounded-xl text-sm text-slate-700 hover:bg-slate-100 font-medium transition-colors">
