                ...
                <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="<?php echo e(route('properties.show', $appointment->property)); ?>" class="text-sm font-bold text-gray-800 hover:text-blue-600">
                                <?php echo e($appointment->property->title); ?>

                            </a>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo e($appointment->client->name); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <p class="text-sm font-bold text-gray-800"><?php echo e($appointment->scheduled_at->format('M d, Y')); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($appointment->time_slot); ?></p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="py-1 px-3 rounded-full text-[10px] font-bold
                                <?php echo e($appointment->status === 'confirmed' ? 'bg-emerald-100 text-emerald-700' : ($appointment->status === 'pending' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700')); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <?php if($appointment->status === 'pending'): ?>
                                <form action="<?php echo e(route('agent.appointments.confirm', $appointment)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('agent.appointments.cancel', $appointment)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('agent.appointments.show', $appointment)); ?>" class="text-xs text-blue-600 hover:underline">View</a>
                            <?php endif; ?>
                        </td>
                    </tr>
