...
<div class="flex flex-col lg:flex-row h-[calc(100vh-200px)] gap-0 bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
    <div class="w-full lg:w-1/3 border-r border-gray-100 flex flex-col bg-gray-50/30">
        <div class="p-6 border-b border-gray-100">
            ...
            <div class="relative">
                ...
                <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4">
                    <svg class="size-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <div class="overflow-y-auto flex-1">
            <a href="<?php echo e(route('buyer.messages.show', $user)); ?>"
                ...
                <div class="grow min-w-0">
                    <h3 class="font-bold text-sm text-gray-800 truncate"><?php echo e($user->name); ?></h3>
                    <p class="text-xs text-gray-500 truncate font-medium"><?php echo e($user->email); ?></p>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="w-full lg:w-2/3 flex flex-col relative h-full">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-white">
            <div class="flex items-center gap-x-4">
                ...
                <div>
                    <h2 class="font-black text-gray-800"><?php echo e($user->name); ?></h2>
                    <p class="text-xs font-bold text-gray-400"><?php echo e($user->email); ?></p>
                </div>
            </div>
        </div>
                ...
                <?php else: ?>
                    <div class="flex gap-x-4 max-w-lg">
                        ...
                        <div class="bg-white border border-gray-100 rounded-2xl rounded-tl-none p-4 shadow-sm">
                            <p class="text-sm text-gray-800 font-medium whitespace-pre-wrap"><?php echo e($msg->content); ?></p>
                            <span class="text-[10px] text-gray-400 font-bold mt-2 block"><?php echo e($msg->created_at->format('h:i A')); ?></span>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="p-6 bg-white border-t border-gray-100">
            <form action="<?php echo e(route('buyer.messages.store')); ?>" method="POST" class="flex items-center gap-3">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.buyer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GitHub\PropertyHub-PFE\PropertyHub-PFE\PropertyHub\resources\views/buyer/messages/show.blade.php ENDPATH**/ ?>